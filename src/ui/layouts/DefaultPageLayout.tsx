...
const DefaultPageLayoutRoot = React.forwardRef<HTMLElement, DefaultPageLayoutRootProps>(function DefaultPageLayoutRoot(
  ...
  return (
    ...
    >
      ...
      <div className="hidden xl:block flex-none w-full z-50 sticky top-0 bg-default-background border-b border-neutral-border">
      ...
      <div className="xl:hidden flex-none w-full z-50 sticky top-0 bg-default-background border-b border-neutral-border">
