...
const ProductDetailNew: React.FC = () => {
  ...
  return (
    <DefaultPageLayout>
      ...
      <div className="flex w-full items-center gap-4 px-4 md:px-8 lg:px-12 -mt-2">
        ...
        <div className="flex w-full flex-col items-start justify-center gap-4">
          <div className="flex w-full flex-col lg:flex-row items-start gap-6 lg:gap-12">
            ...
            <div className="flex w-full lg:w-1/2 flex-col items-start gap-4">
              ...
              {/* Seller Information - UPDATED FOR MOBILE RESPONSIVENESS */}
              <div 
                className="flex w-full flex-col sm:flex-row items-center sm:items-center gap-4 rounded-md border border-solid border-neutral-200 bg-default-background p-4 sm:p-6 cursor-pointer hover:bg-neutral-50 transition-colors"
              ...
              >
                ...
                <div className="flex flex-row sm:flex-col md:flex-row gap-2 mt-2 sm:mt-0">
                  ...
                  <IconButton
                    ...
                    onClick={(e) => {
                      e.stopPropagation();
                      window.location.href = `mailto:${product.seller.contact.email}`;
                    }}
                  />
                  <IconButton
                    variant="neutral-primary"
                    ...
                    onClick={(e) => {
                      e.stopPropagation();
                      window.location.href = `tel:${product.seller.contact.phone.replace(/[^0-9]/g, '')}`;
                    }}
                  />
                </div>
              </div>
