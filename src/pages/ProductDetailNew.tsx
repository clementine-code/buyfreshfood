      ...
      <div className="flex w-full flex-col items-start justify-center gap-4">
        <div className="flex w-full flex-col lg:flex-row items-start gap-6 lg:gap-12">
            ...
            <div className="flex w-full lg:w-1/2 flex-col items-start gap-4">
              ...
              {/* Seller Information */}
              <div className="flex w-full max-w-md mx-auto lg:max-w-none lg:mx-0 flex-col sm:flex-row items-start sm:items-center gap-4 rounded-md border border-solid border-neutral-200 bg-default-background p-4 sm:p-6">
                <Avatar
                  size="x-large"
